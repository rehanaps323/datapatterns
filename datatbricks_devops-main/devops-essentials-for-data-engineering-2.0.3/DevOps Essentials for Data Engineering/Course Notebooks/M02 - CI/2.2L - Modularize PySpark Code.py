...
def load_data(nyctaxi):
    return spark.read.table("samples.nyctaxi")
...
## convert_miles_to_km
def convert_miles_to_km(miles): return miles * 1.60934

# COMMAND ----------

## uppercase_column_names function: Converts all column names in the DataFrame to uppercase
def uppercase_column_names(df: DataFrame) -> DataFrame:
